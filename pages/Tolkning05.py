...
# 🔹 **Titel**
st.title("Tolkning av Patientscenario 5")
...
if not df.empty:
    ...
    if selected_code and selected_code != "Välj dokumentationskod":
        ...
        patient_data = df[df["Kod"] == selected_code].dropna(subset=["Feber", "Lunginflammation", "Astma", "Rökning"]).tail(1)
        ...
        if not patient_data.empty:
            ...
            st.write("Vi läser nu vad en kollega dokumenterat om patient Lotten Larsson, 29 år, som sökt sig till vårdcentralen.")

            # 🔹 **Hämta de OpenEHR-kategorier som gäller för detta patientfall**
