...
# 🔹 **Titel**
st.title("Tolkning av Patientscenario 2")
...
if selected_code and selected_code != "Välj dokumentationskod":
    ...
    relevant_cols = ["Blodförtunnande mediciner", "Slagit i huvudet", "Huvudvärk", "Synpåverkan"]
    ...
    st.write("Vi läser nu vad en kollega dokumenterat om patient Mats Matsson, 73 år.")
